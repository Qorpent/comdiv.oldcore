    ...
    public class IgnoreNull : IQuackFu{
        ...
        public object QuackGet(string name, object[] parameters){
            ...
            if (IsNullOrEmpty(parameters)){
                ...
                value = ExpandDuckTypedExpressions_WorkaroundForDuplicateVirtualMethods.GetSlice(target, name,
                                                                                                 parameters);
            }
        ...
        private static object[] GetParameterArray(object[] parameters, object obj){
            return new System.Collections.Generic.List<object>(parameters){obj}.ToArray();
        }
