...
namespace Castle.MonoRail.Views.Brail
{
	...
	public class ComponentMacro : AbstractAstMacro
	{
		...
		public override Statement Expand(MacroStatement macro)
		{
			...
			var ctx = "context" + counter++;
			block.Add(new DeclarationStatement(new Declaration(ctx, new SimpleTypeReference("Castle.MonoRail.Views.Brail.BrailViewComponentContext")),initContext));
			...
			block.Add(new BinaryExpression(BinaryOperatorType.Assign,
			                               new ReferenceExpression(componentContextName), new ReferenceExpression(ctx)));
			...
			block.Add(new MethodInvocationExpression(
						AstUtil.CreateReferenceExpression(ctx + ".Clear")));
			return block;
		}
